...
public:
  Work_Packet()
      : n_particles(0), g_cell_ID(0), g_grip_ID(0), n_create(0), n_census(0),
        source_type(0), census_index_start(0), create_E(0.0) {}
  ~Work_Packet() {}
  ...
  void attach_creation_work(const double _create_E, const uint32_t _n_create) {
    create_E = _create_E;
    n_create = _n_create;
  ...
  void set_source_type(uint32_t _source_type) { source_type = _source_type; }
